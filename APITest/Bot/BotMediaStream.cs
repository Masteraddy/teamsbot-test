...
namespace APITest.Bot
{
    ...
    public class BotMediaStream : ObjectRootDisposable
    {
        ...
        public async Task ShutdownAsync()
        {
            ...
            var alltranscript = FileHelper.ReadFile(this.ID + ".txt");
            FileHelper.DeleteFile(this.ID + ".txt");
        ...
        private async void OnAudioMediaReceived(object? sender, AudioMediaReceivedEventArgs e)
        {
            ...
            try
            {
                ...
                if (_languageService != null)
                {
                    ...
                    await _languageService.AppendAudioBuffer(this.dominantSpeaker, e.Buffer, this.ID);
                    e.Buffer.Dispose();
                }
                else
                {
                    ...
                    if (length > 0)
                    {
                        ...
                        this.audioMediaBuffers = LUtilities.CreateAudioMediaBuffers(buffer, currentTick, _logger);
